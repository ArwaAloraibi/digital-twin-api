...
def create_test_users():
    user1 = UserModel(username="arjun_dev")
    user1.set_password("securepassword1")

    user2 = UserModel(username="emma_johnson")
    user2.set_password("securepassword2")

    user3 = UserModel(username="fatima_ali")
    user3.set_password("securepassword3")

    user4 = UserModel(username="lucas_silva")
    user4.set_password("securepassword4")

    user5 = UserModel(username="elena_popov")
